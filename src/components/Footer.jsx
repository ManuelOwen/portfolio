 const Footer = () => {
 return (   
 <footer className="footer footer-center bg-red-500 text-base-content rounded p-10">
  ...
  <aside>
    <p>Copyright © ${new Date().getFullYear()} - All right reserved by Emmanuel Kibet</p>
  </aside>
</footer>
) }
